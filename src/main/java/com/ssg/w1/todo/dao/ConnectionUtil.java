...
public enum ConnectionUtil {
  ...
  // 외부에서는 ConnectionUtil.INSTANCE.getConnection() 을 통해 Connection 을 받을 수 있다.
  ...
  ConnectionUtil() {
    ...
    config.setJdbcUrl("jdbc:mysql://localhost:3306/ssgdatabase?characterEncoding=UTF-8&serverTimezone=UTC");
